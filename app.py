...
def generate_questions_app():
    ...
    new_reader = FARMReader(model_name_or_path="https://drive.google.com/drive/folders/15hxzmTToe7qd_I-W40PfHhqg_ghWHddj?usp=drive_link")

    tokenizer = AutoTokenizer.from_pretrained("https://drive.google.com/drive/folders/10GFyDy1itWjlA3p_KVwdZRk6ZFxejWYa?usp=drive_link")
    model = AutoModelWithLMHead.from_pretrained("https://drive.google.com/drive/folders/10GFyDy1itWjlA3p_KVwdZRk6ZFxejWYa?usp=drive_link")
